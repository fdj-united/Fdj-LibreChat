...
describe('tenant isolation', () => {
  test('snapshot save guards preserve caller predicates and strict tenant isolation across saves', async () => {
    ...
    const originalStrictMode = process.env.TENANT_ISOLATION_STRICT;
