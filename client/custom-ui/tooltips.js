...
export function createTooltipsAmendment() {
  var MENU_ITEMS = {
    ...
    "From SharePoint":
      "This is a one-off load of a file from SharePoint. This is not a live feed."
  };

  var INJECT_ATTR =
    "data-kait-info-injected";
  var ORIGINAL_TEXT_ATTR =
    "data-kait-original-text";
  ...
  function injectInfoIcon(element) {
    ...
    if (
      element.getAttribute(INJECT_ATTR) === "true"
    ) {
      return;
    }
