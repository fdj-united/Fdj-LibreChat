    ...
    >
      {items.map(({ mode, label, icon: Icon }) => (
        <button
          ...
          className={cn(
            'inline-flex size-9 items-center justify-center rounded-lg text-text-secondary transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring',
            viewMode === mode
      ...
      <DropdownPopup
        ...
        trigger={
          <Ariakit.MenuButton
            ...
            className={cn(
              'inline-flex size-9 shrink-0 items-center justify-center rounded-lg text-text-secondary transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring group-hover/artifact:bg-surface-primary group-hover/artifact:text-text-primary',
              ...
              >
                {SCOPES.map((candidate) => (
                  <button
                    ...
                    className={cn(
                      'relative cursor-pointer select-none whitespace-nowrap px-3 py-2 text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
